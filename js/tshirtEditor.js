...
var line4;
 	$(document).ready(function() {
		...
		$('#imgADD').click(function(){
			...
			var img_name = img.substr(img.lastIndexOf('\\')+1,img.length);
			//console.log(img_name);
			var html = '<img style="cursor:pointer;" class="img-polaroid" id="cust-img" src="img/'+img_name+'">';
			console.log(html);
			$('#avatarlist').append(html);
		});
	   ...
	   $('#flip').click(
		   function() {			   
			   	if ($(this).attr("data-original-title") == "Show Back View") {
			        ...
			        if($('#tshirtCombo').val()=="crew_front")
			        {
			        	$("#tshirtFacing").attr("src","img/crew_back.png");
			        }
			        else if($('#tshirtCombo').val()=="mens_longsleeve_front")
			        {
			        	$("#tshirtFacing").attr("src","img/mens_longsleeve_back.png");
			        }

			        else if($('#tshirtCombo').val()=="mens_tank_front")
			        {
			        	$("#tshirtFacing").attr("src","img/mens_tank_back.png");
			        }
			        else if($('#tshirtCombo').val()=="mens_hoodie_front")
			        {
